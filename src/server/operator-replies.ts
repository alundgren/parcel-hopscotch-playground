  ...
  questions: {
    reply: {
      ...
      criteria: {
        ...
        ready_help: "Asks how or where to review or approve the orders in Ready, including where the Ready filter or Review ready orders control is. This is procedural help, not a request to open the preview or accept changes. For example: 'can you help me out with how to approve the ones in ready?' A direct request to prepare or open the full Ready preview belongs to model.",
